...
class ComplianceRouter:
    ...
    def _set_region(self, region: str):
        ...
        if region == "australia":
            ...
            st.session_state.compliance_agents = load_australian_agents()
        elif region == "united_states":
            from us_compliance_adapter import load_us_agents
            st.session_state.compliance_agents = load_us_agents()
        elif region == "global":
...
import streamlit as st
from geographic_router import ComplianceRouter
